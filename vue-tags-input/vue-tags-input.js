...
export default {
    ...
    methods: {
        ...
        performDeleteTag(index) {
            if (!this.$attrs.onBeforeDeletingTag) this.deleteTag(index);
            /**
        ...
        performAddTags(tag, event, source) {
            ...
            tags.forEach(tag => {
                ...
                if (!this.$attrs.onBeforeAddingTag) this.addTag(tag, source);
                /**
        ...
        performSaveTag(index, event) {
            ...
            if (!this.$attrs.onBeforeSavingTag) this.saveTag(index, tag);
            /**
